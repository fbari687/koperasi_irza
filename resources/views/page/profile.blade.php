            ...
            <form action="{{ route('editProfile') }}" method="POST" class="grid grid-cols-3 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="class" id="class"
                        ...
                        <option value="XII-RPL" class="{{ Auth::user()->class == "XII-RPL" ? "hidden" : '' }}">XII-RPL</option>
                        <option value="XI-PPLG1" class="{{ Auth::user()->class == "XI-RPL" ? "hidden" : '' }}">XI-PPLG1</option>
                        <option value="X-PPLG1" class="{{ Auth::user()->class == "X-RPL" ? "hidden" : '' }}">X-PPLG1</option>
                    </select>
                </div>
